...
class APIDataset(data.Dataset):
    ...
    def __getitem__(self, index):
        pos, api_len = self.api_index[index]['pos'], self.api_index[index]['length']
        ...
        pos, desc_len = self.desc_index[index]['pos'], self.desc_index[index]['length']
