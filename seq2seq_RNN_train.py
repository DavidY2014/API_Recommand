...
def train(args):
    ...
    # Load data
    ###############################################################################
    train_set=APIDataset(args.data_path+'test.desc.h5', args.data_path+'test.apiseq.h5', config['max_sent_len'])
    ...
    for epoch in range(start_epoch, config['epochs']+1):
        ...
        for batch in train_loader:# loop through all batches in training data
            ...
            #这一次是直接输入了batchsize的desc,desc_len,api,api_len的数据进入model
